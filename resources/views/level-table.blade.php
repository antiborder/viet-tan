...
@section('content')
  ...
  <div class="container" style="max-width:800px">
    <div class="card my-3 p-0">
        <h5 class="p-1 m-2"><span class="">べとらん</span><small>の</small>単語レベル一覧</h5>
    ...
    <div class="card my-3 p-0">    
        <h5 class="p-1 mx-2">初級レベル　<span class="text-nowrap" style="font-size:0.8rem">―最低限覚えておきたい1300語―</span></h5>
        <p class="px-1 mx-2">
            広告、通知、注意書き等の簡単な文はだいぶ読めるようになってきます。<br>
            ここまでの単語を初級文法で組み合わせるだけでも大抵のことは伝えられますので、このレベルが咄嗟に出てくるかどうかで対応力に差が出ます。<br>
